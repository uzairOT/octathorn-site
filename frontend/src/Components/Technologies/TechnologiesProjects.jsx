...
function TechnologiesProjects() {
    let { heading } = useParams();
    // let heading=category.replace(/-/g, ' ');


    if (heading === "internetofthings") {
        heading = "IoT";
    }
    else if (heading === "frontend") {
        heading = "Front End";
    }
    else if (heading === "backend") {
        heading = "Back End";
    }
    else if (heading === "embeddedsystem") {
        heading = "Embedded";
    }
    else if (heading === "mobileAppdevelopment") {
        heading = "Mobile";
    }
    ...
    useEffect(() => {
        axios.get('https://octathorn.com/api/project')
            .then(response => {
                const filteredData = response.data.filter(item => item.category === heading);
                                    ...
                                    <>
                                        ...
                                        <Grid item xs={12} sm={12} md={12} lg={6} mt={1}>
                                            ...
                                            <Card sx={{ ...themeStyles.contentCard, }}>
                                                <CardContent>
                                                    <Typography sx={themeStyles.cardtitle}>
                                                        {project.title}
                                                    </Typography>
